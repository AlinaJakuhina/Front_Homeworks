...
passInput.setAttribute("placeholder", 'Введите пароль');
passInput.style.cssText = 'width: 100%; height: 35px;  margin-bottom: 10px; outline: none';

let passwordBatton = document.createElement('button');
passwordBatton.classList.add('pass');
passwordBatton.innerText = "Скрыть";

passwordBatton.style.cssText = 'margin-top: 20px; border: none; width: 100%; background-color: lightseagreen; height: 35px; color: white; cursor: pointer; font-weight: bold';


passwordDiv.append(passInput, passwordBatton);
document.body.appendChild(passwordDiv);


passwordBatton.onclick = () => {
